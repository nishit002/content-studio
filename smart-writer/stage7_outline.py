...
def run(
    ...
    if checkpoint.exists():
        ...
        return _parse_outline(data, writing_style)
    ...
    return _parse_outline(result, writing_style)
...
def _parse_outline(data: dict, writing_style: str = "comprehensive") -> ArticleOutline:
    sections = []
